...
class Bootstrap_NavWalker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( $depth === 0 && in_array( 'menu-item-has-children', $classes ) ) {
			...
			$atts['data-toggle']   = 'dropdown 1000 true'; /* u originalu stoji samo 'dropdown' kad dropdown link nije klikabilan*/
			$atts['id']            = 'navbar-dropdown-menu-link-' . $item->ID;
			$atts['aria-haspopup'] = "true";
			$atts['aria-expanded'] = "false";
			$atts['href']          = ! empty( $item->url ) ? $item->url : ''; /* u originalu stoji samo '#' kad dropdown link nije klikabilan*/
		}
